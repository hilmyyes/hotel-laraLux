            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                        ...
                        <span class="username username-hide-on-mobile">{{ optional(Auth::user())->name ?? 'Not Logged In' }}</span>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="{{ route('hotel.index') }}">
                                    <i class="icon-settings"></i> Index </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('hotel.create') }}">
                                    <i class="icon-globe"></i> Create </span>
                                </a>
                            </li>
                        </ul>
                    </li>
