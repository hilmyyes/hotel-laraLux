        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p>Kami menawarkan berbagai layanan dan fasilitas untuk memastikan kenyamanan dan kepuasan Anda
                        selama menginap bersama kami.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <h4><a href="">Layanan Kamar</a></h4>
                            <p>Layanan kamar 24 jam untuk pesan makanan dan minuman dan nikmati kenyamanan yang tak
                                tertandingi di kamar-kamar kami. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Restoran dan Cafe</a></h4>
                            <p>Nikmati hidangan lezat di restoran dan cafe kami. Menu yang beragam dari masakan lokal
                                hingga internasional akan memanjakan lidah Anda.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Rileks dan nikmati suasana di sekitar kolam renang kami. Kolam renang yang bersih dan
                                terawat dengan baik untuk membuat Anda merasa segar kembali.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Fasilitas untuk keperluan bisnis tamu hotel.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Spa dan Pijat</a></h4>
                            <p>Rileks dan lepaskan penat dengan layanan spa dan pijat kami. Terapis profesional kami
                                akan membantu Anda merasa segar dan bugar kembali.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Fasilitas Meeting dan Event</a></h4>
                            <p>Kami menyediakan fasilitas meeting dan event yang lengkap untuk keperluan bisnis atau
                                acara khusus Anda.</p>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="img/12.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="img/11.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="img/10.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="img/5.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="img/6.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <img src="img/7.jpeg" width="500" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <img src="img/8.jpeg" width="500"class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="img/9.jpeg" width="500"class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <img src="img/2.jpeg" width="500"class="img-fluid" alt="">
                    </div>
                </div>
