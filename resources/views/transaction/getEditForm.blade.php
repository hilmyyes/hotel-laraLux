        ...
        @foreach ($data->products as $transactionProduct)
            <div id="product_{{ $transactionProduct->id }}" class="product-block">
                <div class="form-group">
                    ...
                    <select class="form-control product-select" name="products[{{ $transactionProduct->id }}]" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateSubtotal(input) {
                ...
                var price = $('select[name="products[' + productId + ']"] option:selected').data('price');
